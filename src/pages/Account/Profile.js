...
const Profile = () => {
  ...
  const handleSubmit = () => {
    fetch(`https://coherent-alike-patient.glitch.me/user/info/${user._id}`, {
      method: "POST",
      body: JSON.stringify({
        fullname: name,
        mobile: phone,
  ...
  return (
    <>
      ...
      <section className="main">
        <SubHeader title="Account Profile" />
        <div className="profile-container">
          ...
          <div className="profile-form">
            ...
            <div>
              <p style={{ margin: "0px", color: "grey" }}>Full Name</p>
              ...
              <p style={{ margin: "0px", color: "grey" }}>Mobile</p>
              <InputGroup className="mb-3">
                <Form.Control
                  aria-label="Mobile"
                  aria-describedby="basic-addon1"
              ...
              <p style={{ margin: "0px", color: "grey" }}>Bitcoin Address</p>
              <InputGroup className="mb-3">
                <Form.Control
              ...
              <p style={{ margin: "0px", color: "grey" }}>Country</p>
              <InputGroup className="mb-3">
                <Form.Select
              ...
              <p style={{ margin: "0px", color: "grey" }}>Next of Kin's Name</p>
              <InputGroup className="mb-3">
                <Form.Control
                  aria-label="Kin"
                  aria-describedby="basic-addon1"
